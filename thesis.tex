...
Die Kunst der Modellierung besteht darin, ein optimales Modell(siehe mittleren Graphen \ref{fig:overUnderFitting}) zu finden, dass eine perfekte Balance zwischen Verzerrung und Abweichung der Daten besitzt. Dieses Modell sollte eine so gering wie mögliche Komplexität und gut beschriebene Daten haben. Da das nicht immer einfach ist, treten in der Generalisierung Underfitting und Overfitting auf, siehe Abschnitt \ref{section:OverUnderfitting}.
